...
my::Calculator calculator_;

TEST(calculator, test_easy_num_1) {
  string str1("");
  string str1_result = calculator_.CalculateResult(&str1);
  string str1_answer("0.0000000");
  EXPECT_TRUE(str1_result == str1_answer);

  string str2("10");
  string str2_result = calculator_.CalculateResult(&str2);
  string str2_answer("10.0000000");
  EXPECT_TRUE(str2_result == str2_answer);

  string str3("-10");
  string str3_result = calculator_.CalculateResult(&str3);
  string str3_answer("-10.0000000");
  EXPECT_TRUE(str3_result == str3_answer);

  string str4("2.222");
  string str4_result = calculator_.CalculateResult(&str4);
...
TEST(calculator, test_dot_error_2) {
  ...
  string str5("..2+3.3");
  string str5_result = calculator_.CalculateResult(&str5);
  string str5_answer = ERROR1;
  EXPECT_TRUE(str5_result == str5_answer);

  string str6("5.5.5+5");
  string str6_result = calculator_.CalculateResult(&str6);
  string str6_answer = ERROR1;
  EXPECT_TRUE(str6_result == str6_answer);

  string str7("2.2-3..3");
  string str7_result = calculator_.CalculateResult(&str7);
...
TEST(calculator, test_bracket_6) {
  ...
  string str14_result = calculator_.CalculateResult(&str14);
  string str14_answer("230.0000000");
  EXPECT_TRUE(str14_result == str14_answer);

  string str15("(20-(2*(2+8)))");
  string str15_result = calculator_.CalculateResult(&str15);
  string str15_answer("0.0000000");
  EXPECT_TRUE(str15_result == str15_answer);

  string str16("(+5)");
  string str16_result = calculator_.CalculateResult(&str16);
